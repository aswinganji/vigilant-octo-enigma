    ...
    def _Radar_callback(radar_data):
        ...
        for detection in radar_data:
            ...
            if prediction == 1 :
                ...
                dropped_vehicle.apply_control(carla.VehicleControl(carla.VehicleLightState.Reverse))
                break
                ...
                dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.5))
                dropped_vehicle.apply_control(carla.VehicleControl(carla.VehicleLightState.LowBeam))
                break
